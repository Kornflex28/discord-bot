...
module.exports = {
    ...
    execute(message, args) {
        ...
        if (process.env.HEROKU_RELEASE_VERSION) {
            return message.channel.send(`Je me suis levé il y a ${uptime} et c'est ma version **${parseInt(process.env.HEROKU_RELEASE_VERSION)/2}** que j'utilise en ce moment ! `);
        } else {
