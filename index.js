    ...
    if (!message.author.bot) {
        ...
        if (message.guild) {
            ...
            if (hasLeveledUp) {
                ...
                message.channel.send(`${message.author}, ${lvlUpMessages[Math.floor(Math.random()*lvlUpMessages.length)]} Tu as gagné un niveau, tu es desormais niveau **${user.level}**. :tada:`);
            }
        }
